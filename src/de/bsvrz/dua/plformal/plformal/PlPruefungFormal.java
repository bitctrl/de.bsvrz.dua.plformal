...
public class PlPruefungFormal extends AbstraktBearbeitungsKnotenAdapter
		...
		if (this.ppfParameter == null) {
			...
			for (ResultData resultat : resultate) {
				...
				if (resultat.getData() != null) {
					...
					if (pData != null) {
						ResultData ersetztesResultat = new ResultData(resultat
	 ...
	 */
	private void sendeSinnvoll(ResultData resultat) {
		if (resultat.getData() == null) {
			Boolean keineDaten1 = this.keineDaten.get(resultat.getObject());
